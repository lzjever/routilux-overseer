...
export class FlowsService {
   ...
   * @throws ApiError
   */
  public static getFlowApiV1FlowsFlowIdGet(flowId: string): CancelablePromise<FlowResponse> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteFlowApiV1FlowsFlowIdDelete(flowId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/v1/flows/{flow_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getFlowMetricsApiV1FlowsFlowIdMetricsGet(flowId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static validateFlowApiV1FlowsFlowIdValidatePost(flowId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
