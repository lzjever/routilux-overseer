...
describe("useWorkersStore", () => {
  ...
  describe("loadWorkers", () => {
    ...
    it("should handle API errors", async () => {
      vi.mocked(queryService.workers.list).mockRejectedValueOnce(new Error("Network error"));
  ...
  describe("loadWorker", () => {
    ...
    it("should handle missing worker", async () => {
      vi.mocked(queryService.workers.get).mockRejectedValueOnce(new Error("Worker not found"));
  ...
  describe("createWorker", () => {
    ...
    it("should handle creation errors", async () => {
      vi.mocked(queryService.workers.create).mockRejectedValueOnce(new Error("Invalid flow"));
  ...
  describe("pauseWorker", () => {
    ...
    it("should handle pause errors", async () => {
      vi.mocked(queryService.workers.pause).mockRejectedValueOnce(new Error("Cannot pause worker"));
