...
vi.mock("@/lib/services/query-service", () => ({
  queryService: {
    jobs: {
      ...
      getMonitoringData: vi.fn((id: string) =>
        Promise.resolve({
          job_id: id,
          routines: [],
        })
      ),
      getMetrics: vi.fn((id: string) =>
        Promise.resolve({
          job_id: id,
...
describe("useJobStore", () => {
  ...
  describe("loadJobs", () => {
    ...
    it("should handle API errors", async () => {
      vi.mocked(queryService.jobs.list).mockRejectedValueOnce(new Error("Network error"));
  ...
  describe("loadJob", () => {
    ...
    it("should handle missing job", async () => {
      vi.mocked(queryService.jobs.get).mockRejectedValueOnce(new Error("Job not found"));
  ...
  describe("submitJob", () => {
    ...
    it("should handle submission errors", async () => {
      vi.mocked(queryService.jobs.submit).mockRejectedValueOnce(new Error("Invalid flow"));
  ...
  describe("loadJobMonitoringData", () => {
    ...
    it("should handle monitoring data errors", async () => {
      ...
      mockGetMonitoringData.mockRejectedValueOnce(new Error("Monitoring data not available"));
  ...
  describe("loadJobMetrics", () => {
    ...
    it("should handle metrics errors", async () => {
      ...
      mockGetMetrics.mockRejectedValueOnce(new Error("Metrics not available"));
