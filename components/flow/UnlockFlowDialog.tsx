    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Editing this flow will affect all running jobs.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Warning: Changes to this flow will immediately affect all running jobs. This may cause
              unexpected behavior or errors in active executions.
            </AlertDescription>
          </Alert>
          ...
          {loading ? (
            <div className="flex items-center justify-center py-4">
              ...
              <span className="ml-2 text-sm text-muted-foreground">Checking running jobs...</span>
            </div>
          ) : runningJobs.length > 0 ? (
            <div className="space-y-2">
              <p className="text-sm font-medium">Running Jobs ({runningJobs.length}):</p>
            ...
            <p className="text-sm text-muted-foreground">No running jobs found for this flow.</p>
          )}
        </div>
